  ...
  return (
    <div className="animate-fade-up space-y-5">
      ...
      <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-5 animate-fade-up delay-300">
        <h2 className="text-base font-bold text-slate-800 mb-4" style={{ fontFamily: "'Syne', sans-serif" }}>
          Income vs Expenses
        </h2>
            ...
            return (
              <div key={label} className="flex flex-col items-center gap-1.5 flex-1">
                ...
                <div className="w-full flex items-end justify-center">
                  <div className={`w-full max-w-[60px] rounded-t-xl ${color} transition-all duration-700`} style={{ height: `${h}%`, minHeight: '12px' }} />
                </div>
