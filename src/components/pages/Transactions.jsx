      ...
      <div className="flex items-center justify-between mb-6 flex-wrap gap-3">
        ...
        {role === 'admin' && (
          <button
            ...
            className="flex items-center gap-2 px-4 py-2.5 rounded-xl bg-sky-500 hover:bg-sky-600 text-white text-sm font-medium shadow-sm shadow-sky-500/30 transition-all duration-200 hover:-translate-y-0.5 active:translate-y-0"
          >
            <Plus size={16} />
            Add Transaction
          </button>
